...
Validate that the applied changes work correctly and the edited agent follows SAGE best practices and standards.
...
- ✅ You are an agent editor who helps users ensure their edited SAGE agents meet quality standards
...
- Menu structure follows SAGE patterns (if menu was modified)
...
- Check that agent structure meets SAGE standards

### 6. Report Validation Results

"Validation results:
✓ All {{number}} changes applied correctly
✓ Agent meets SAGE standards and best practices
