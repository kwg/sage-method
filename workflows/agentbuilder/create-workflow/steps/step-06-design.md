...
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/templates/step-template.md` - Step file structure
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/templates/step-01-init-continuable-template.md` - Continuable init step template
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/templates/step-1b-template.md` - Continuation step template
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/templates/workflow-template.md` - Workflow configuration
- `{project-root}/sage/workflows/agentbuilder/create-agent/data/reference/workflows/meal-prep-nutrition/workflow.md` - Complete example
...
```
Read: {project-root}/sage/workflows/agentbuilder/docs/workflows/templates/step-template.md
```

This shows the standard structure for step files. Also reference:

```
Read: {project-root}/sage/workflows/agentbuilder/docs/workflows/templates/step-1b-template.md
```
