...
- Agent compilation guide: `{project-root}/sage/workflows/agentbuilder/docs/agents/agent-compilation.md`
- Agent types guide: `{project-root}/sage/workflows/agentbuilder/docs/agents/understanding-agent-types.md`
- Architecture docs: simple, expert, module agent architectures
- Menu patterns guide: `{project-root}/sage/workflows/agentbuilder/docs/agents/agent-menu-patterns.md`
