...
# Path Definitions
workflow_path: '{project-root}/sage/workflows/agentbuilder/edit-workflow'

# File References
thisStepFile: '{workflow_path}/steps/step-05-compliance-check.md'
workflowFile: '{workflow_path}/workflow.md'
editedWorkflowPath: '{target_workflow_path}'
complianceCheckWorkflow: '{project-root}/sage/workflows/agentbuilder/workflow-compliance-check/workflow.md'
outputFile: '{output_folder}/workflow-edit-{target_workflow_name}.md'

# Task References
complianceCheckTask: '{project-root}/sage/workflows/agentbuilder/workflow-compliance-check/workflow.md'
---
...
Run comprehensive compliance validation on the edited workflow using the workflow-compliance-check workflow to ensure it meets all SAGE standards before completion.
...
- ✅ You bring expertise in SAGE standards and workflow validation
...
Your workflow has been edited! Now let's run a comprehensive compliance check to ensure it meets all SAGE standards and follows best practices.
...
- Refer to SAGE documentation for best practices
...
- Final edited workflow meets SAGE standards and is ready for production
