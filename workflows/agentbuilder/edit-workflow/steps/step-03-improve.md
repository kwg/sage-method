...
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/templates/step-template.md`
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/templates/workflow-template.md`
- `{project-root}/sage/workflows/agentbuilder/docs/workflows/architecture.md`
