...
agent_examples_path: '{project-root}/sage/workflows/agentbuilder/reference/agents/module-examples'
...
- ✅ You bring expertise in SAGE agent patterns, user brings their domain requirements
...
I'll create each agent following the proper SAGE template and set up placeholder workflow folders for them."
...
agent:
  ...
  menu:
    ...
    - trigger: 'complex-process'
      route: '{project-root}/_sage/{custom_module}/workflows/[workflow]/workflow.md'
