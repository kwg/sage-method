...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with the current user journey content
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with the current user journeys
