...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with the current journey content
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with the current journeys
...
- Load `{project-root}/sage/workflows/software/2-plan-workflows/prd/steps/step-05-domain.md` (or determine if step is optional based on domain complexity)
