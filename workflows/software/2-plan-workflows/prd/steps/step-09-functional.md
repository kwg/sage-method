...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with the current FR list
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with the current FR list
...
- Load `{project-root}/sage/workflows/software/2-plan-workflows/prd/steps/step-10-nonfunctional.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/sage/workflows/software/2-plan-workflows/prd/steps/step-10-nonfunctional.md` to define non-functional requirements.
