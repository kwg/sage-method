...
# Path Definitions
workflow_path: '{project-root}/sage/workflows/software/3-solutioning/implementation-readiness'
...
epicsBestPractices: '{project-root}/sage/workflows/software/3-solutioning/create-epics-and-stories'
---
