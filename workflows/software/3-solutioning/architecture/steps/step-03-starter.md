...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with current starter analysis
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with starter evaluation context
