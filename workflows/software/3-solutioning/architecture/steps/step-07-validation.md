...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with validation issues
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with validation context
