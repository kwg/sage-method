...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with current project structure
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with project structure context
