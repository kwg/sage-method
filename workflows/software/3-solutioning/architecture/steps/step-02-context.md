...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with the current context analysis
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with the current project context
