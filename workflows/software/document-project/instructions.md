...
<critical>You MUST have already loaded and processed: {project-root}/sage/workflows/software/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/sage/workflows/software/workflow-status">
