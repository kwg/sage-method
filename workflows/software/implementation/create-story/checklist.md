...
- The `{project_root}/sage/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project_root}/sage/core/tasks/validate-workflow.xml`
