...
1. Load relevant knowledge fragments from `{project-root}/sage/workflows/software/testarch/tea-index.csv`:
...
3. Read related SAGE artifacts (if available):
...
## Integration with SAGE Artifacts
