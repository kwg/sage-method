...
**Note:** SAGE artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of SAGE artifacts does NOT halt workflow
...
**SAGE-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (SAGE-Integrated, Standalone, Auto-discover)
...
### With SAGE Workflows (If Available - OPTIONAL)
...
- [ ] **Execution mode determined** (SAGE-Integrated, Standalone, or Auto-discover)
...
### Issue: SAGE artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require SAGE artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without SAGE context
...
- Message: "Framework scaffolding required. Run `sage tea *framework` first."
...
- **automate is flexible:** Can work with or without SAGE artifacts (story, tech-spec, PRD are OPTIONAL)
