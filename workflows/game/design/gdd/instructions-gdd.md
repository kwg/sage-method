...
<invoke-workflow path="{project-root}/sage/core/workflows/workflow-status">
...
<check if="user selects option 1 or fuzzy indicates wanting to create the narrative design document">
  <invoke-workflow>{project-root}/sage/workflows/game/design/narrative/workflow.yaml</invoke-workflow>
