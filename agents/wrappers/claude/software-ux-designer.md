# SAGE UX Designer Agent

**Description**: User experience design and interface planning
...
2. LOAD @sage/agents/software/ux-designer.md - READ the agent's persona and menu
