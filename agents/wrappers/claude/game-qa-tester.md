# SAGE Game QA Tester Agent

**Description**: Autonomous game testing with visual verification and state validation
...
2. LOAD @sage/agents/game/qa-tester.md - READ the agent's persona and menu
