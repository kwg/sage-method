...
**[w] Seems bigger than quick-dev** — see what SAGE Method recommends (workflow-init)
**[e] Execute directly**</ask>
      ...
      <check if="w">
        ...
        <action>EXIT quick-dev - user has been routed to SAGE Method</action>
      </check>
    ...
    <!-- Level 3+: SAGE Method territory, recommend workflow-init -->
    <check if="level 3 or higher">
      <ask>This sounds like platform/system work.

**[w] Start SAGE Method** (recommended) (workflow-init)
