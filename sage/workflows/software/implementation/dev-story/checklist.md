...
- [ ] **Coverage Threshold:** New code has ≥80% line coverage, ≥75% branch coverage (critical code ≥90%)
...
**Naming Convention:**
```
test_<function>_should_<behavior>_when_<condition>
```
Example: `test_login_should_return_token_when_credentials_valid`
