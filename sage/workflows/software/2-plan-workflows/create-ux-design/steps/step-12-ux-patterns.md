...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with the current UX patterns content
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with the current UX patterns
