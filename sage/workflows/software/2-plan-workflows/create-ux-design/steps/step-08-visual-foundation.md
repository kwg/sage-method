...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with the current visual foundation content
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with the current visual foundation
