...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with current scoping analysis
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with scoping context
