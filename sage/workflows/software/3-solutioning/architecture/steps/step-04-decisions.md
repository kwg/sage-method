...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with specific decision categories
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with architectural decisions context
