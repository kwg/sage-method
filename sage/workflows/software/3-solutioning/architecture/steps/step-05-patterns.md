...
- Execute {project-root}/sage/core/tasks/advanced-elicitation.xml with current patterns
...
- Execute {project-root}/sage/core/workflows/party-mode/workflow.md with implementation patterns context
