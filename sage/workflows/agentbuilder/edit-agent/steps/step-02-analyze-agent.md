...
# Path Definitions
workflow_path: '{project-root}/sage/workflows/agentbuilder/edit-agent'
...
understanding_agent_types: '{project-root}/sage/workflows/agentbuilder/docs/agents/understanding-agent-types.md'
agent_compilation: '{project-root}/sage/workflows/agentbuilder/docs/agents/agent-compilation.md'
simple_architecture: '{project-root}/sage/workflows/agentbuilder/docs/agents/simple-agent-architecture.md'
expert_architecture: '{project-root}/sage/workflows/agentbuilder/docs/agents/expert-agent-architecture.md'
module_architecture: '{project-root}/sage/workflows/agentbuilder/docs/agents/module-agent-architecture.md'
menu_patterns: '{project-root}/sage/workflows/agentbuilder/docs/agents/agent-menu-patterns.md'
communication_presets: '{project-root}/sage/workflows/agentbuilder/create-agent/data/communication-presets.csv'
reference_simple_agent: '{project-root}/sage/workflows/agentbuilder/reference/agents/simple-examples/commit-poet.agent.yaml'
reference_expert_agent: '{project-root}/sage/workflows/agentbuilder/reference/agents/expert-examples/journal-keeper/journal-keeper.agent.yaml'
validation: '{project-root}/sage/workflows/agentbuilder/create-agent/data/agent-validation-checklist.md'
---
...
- ✅ You are an agent editor with deep knowledge of SAGE agent architecture
