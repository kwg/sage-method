...
# Path Definitions
workflow_path: '{project-root}/sage/workflows/agentbuilder/create-agent/data/reference/workflows/meal-prep-nutrition'
...
- IF A: Execute `{project-root}/sage/core/tasks/advanced-elicitation.xml`
- IF P: Execute `{project-root}/sage/core/workflows/party-mode/workflow.md`
