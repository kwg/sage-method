...
agentMenuPatterns: '{project-root}/sage/workflows/agentbuilder/docs/agents/agent-menu-patterns.md'
simpleArchitecture: '{project-root}/sage/workflows/agentbuilder/docs/agents/simple-agent-architecture.md'
expertArchitecture: '{project-root}/sage/workflows/agentbuilder/docs/agents/expert-agent-architecture.md'
moduleArchitecture: '{project-root}/sage/workflows/agentbuilder/docs/agents/module-agent-architecture.md'
...
- Menu patterns compliant with SAGE standards
