...
moduleStructureGuide: '{project-root}/sage/workflows/agentbuilder/workflows/create-agent-legacy/create-module/module-structure.md'
...
- ✅ You bring expertise in module design and SAGE patterns, user brings their domain knowledge
