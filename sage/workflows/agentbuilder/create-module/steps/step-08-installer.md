...
- ✅ You bring expertise in SAGE installation patterns, user brings their module requirements
...
- 💬 Follow SAGE installer standards exactly
...
- Standard SAGE installer template to follow
...
1. User runs: `sage install {module_name}`
2. Installer asks: [list of questions]
3. Creates: \_sage/{module_name}/
...
- Installer follows SAGE standards
