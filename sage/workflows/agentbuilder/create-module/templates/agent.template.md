...
agent:
  ...
  critical_actions:
    - 'Load COMPLETE file [project-root]/_sage/_memory/[agent-name]-sidecar/memories.md and integrate all past interactions'
    - 'Load COMPLETE file [project-root]/_sage/_memory/[agent-name]-sidecar/instructions.md and follow ALL protocols'
  ...
  menu:
    ...
    - multi: '[CH] Chat with the agent or [SPM] Start Party Mode'
      triggers:
        - party-mode:
          ...
          route: '{project-root}/sage/core/workflows/edit-agent/workflow.md'
    ...
    - trigger: 'generate-report'
      route: '{project-root}/_sage/{custom_module}/workflows/report-gen/workflow.md'
...
triggers: - party-mode:
input: SPM or fuzzy match start party mode
route: "{project-root}/\_sage/core/workflows/edit-agent/workflow.md"
    ...
    - multi: "[PD] Pitch Deck [EX] Explainer Video"
      triggers:
        - pitch-deck:
          ...
          route: "{project-root}/_sage/{custom_module}/workflows/pitch-deck/workflow.md"
          description: 'Investor pitch deck 📈'
        - explainer:
          input: EX or fuzzy match explainer
          route: "{project-root}/_sage/{custom_module}/workflows/explainer/workflow.md"
