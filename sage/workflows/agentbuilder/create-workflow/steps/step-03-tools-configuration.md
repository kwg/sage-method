...
commonToolsCsv: '{project-root}/sage/workflows/agentbuilder/docs/workflows/common-workflow-tools.csv'
...
- ✅ You bring expertise in SAGE tools and integration patterns
...
Based on your workflow requirements, let's configure all the tools your workflow will need. This includes core SAGE tools, memory systems, and any external integrations."

### 2. Load and Present Available Tools

Load `{commonToolsCsv}` and present tools by category:

"**Available SAGE Tools and Integrations:**
...
### 3. Configure Core SAGE Tools

"**Core SAGE Tools Configuration:**
