...
```
Read: {project-root}/sage/workflows/agentbuilder/create-agent/data/reference/workflows/meal-prep-nutrition/workflow.md
```
...
- **Linear**: Like Meal Prep Plan (Init → Profile → Assessment → Strategy → Shopping → Prep)
  - See: `{project-root}/sage/workflows/agentbuilder/create-agent/data/reference/workflows/meal-prep-nutrition/`
