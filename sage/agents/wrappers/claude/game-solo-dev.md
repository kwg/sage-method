# SAGE Game Solo Dev Agent

**Description**: Indie quick flow specialist - prototype fast, ship faster
...
2. LOAD @sage/agents/game/game-solo-dev.md - READ the agent's persona and menu
