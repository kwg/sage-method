# SAGE Game QA Architect Agent

**Description**: Test strategy, automation design, and QA architecture for games
...
2. LOAD @sage/agents/game/game-qa-architect.md - READ the agent's persona and menu
