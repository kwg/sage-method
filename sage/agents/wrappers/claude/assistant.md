# SAGE Assistant Agent

**Description**: Lifecycle Orchestrator - orchestrate the entire SAGE lifecycle
...
2. LOAD @sage/agents/core/assistant.md - READ the agent's persona and menu
